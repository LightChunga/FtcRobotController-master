...
public class AutoRedLeft extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence firstintake = drive.trajectorySequenceBuilder(new Pose2d(0.00, -38.10, Math.toRadians(270.00)))
                .splineTo(new Vector2d(-50.49, -39.66), Math.toRadians(90.00))
                .build();
